...
<body>
    ...
    <img src="../images/logo.png" style="width:150px;" alt="SAV">
    ...
    <div style="display: flex; justify-content:center; align-items:center; flex-direction: column;" id="agendamento">
    <h1 class="mt-3">Seja bem-vindo ao SAV - Sistema de Agendamento de Vacina!</h1>
    <p><a href="../paginas/entrar" class="btn btn-outline-primary mt-3">Agende sua vacina aqui.</a></p>    
    </div>
    ...
    <div class="container">
        <h2>A vacina pode causa efeito colateral?</h2>
        <h3>Sim, como qualquer medicamento, a vacina pode apresentar efeitos colaterais.</h3>
        <p>Os mais comuns são febre, dor, vermelhidão e inchaço no local da aplicação.</p>
        <h4>O que devo fazer?</h4>
        <p>Coloque apenas compressas frias no local da aplicação.</p>
        <p>
        ...
        <p>Caso apresente nos 7 primeiros dias após a vacinação sintomas de alergia, náuseas, vômitos, diarreia, fraqueza, formigamentos, sintomas de covid-19 (febre, dor de garganta, coriza, falta de ar).</p>
